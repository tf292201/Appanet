using System;
using Godot;
using Appanet.Scripts.Models.Items;           // ← ADD: For Weapon, Armor
using Appanet.Scripts.Models.Combat;          // ← ADD: For AttackResult, DamageType
	...
	public class Ally : Character
	{
		...
		public static Ally CreateMichaelWebb()
		{
			var michael = new Ally(
				...
				12,
				4,
				"res://Assets/Icons/party/MichaelWeb.png" 
			);
		...
		public static Ally CreateDima()
		{
			var dima = new Ally(
				...
				8,
				6,
				"res://Assets/Icons/party/Dima.png" 
			);
			return dima;
		}
		...
		public static Ally CreateCase()
		{
			var case_ally = new Ally(
				...
				14,
				3,
				"res://Assets/Icons/party/Cassie.png" 
			);
