...
using System.Linq;
using Godot;
using Appanet.Scripts.Models.Items;           // ← ADD: For Armor
using Appanet.Scripts.Models.Combat;          // ← ADD: For DamageResistance, StatusEffectInstance, AttackResult, DamageResult, DamageType, StatusEffect
