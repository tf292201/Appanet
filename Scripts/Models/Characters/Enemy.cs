...
namespace Appanet.Scripts.Models.Characters
{
	public class Enemy : Character
	{
		...
		public static Enemy CreateBarnWirePossum()
		{
			return new Enemy(
				...
				EnemyType.Normal, 
				DamageType.Electric,
				"res://Assets/Icons/enemies/Barnwire_Possum.png"
			);
		}
		...
		public static Enemy CreateBackroadsGremmlin()
		{
			return new Enemy(
				...
				EnemyType.Tech, 
				DamageType.Physical,
				"res://Assets/Icons/enemies/Backroads_Gremlin.png"
			);
		}
		...
		public static Enemy CreateRidgeRunnerHowler()
		{
			var howler = new Enemy(
				...
				EnemyType.Normal, 
				DamageType.Physical,
				"res://Assets/Icons/enemies/ridgerunner-howler.png"
			);
		...
		public static Enemy CreateOffGridScavver()
		{
			return new Enemy(
				...
				EnemyType.Normal, 
				DamageType.Physical,
				"res://Assets/Icons/enemies/Off-grid_Scavver.png"
			);
		}
		...
		public static Enemy CreateBunkerBrute()
		{
			return new Enemy(
				...
				EnemyType.Normal, 
				DamageType.Physical,
				"res://Assets/Icons/enemies/bunkerbrute.png"
			);
		}
		...
		public static Enemy CreateBridgeTroll()
		{
			var troll = new Enemy(
				...
				EnemyType.Folklore, 
				DamageType.Physical,
				"res://Assets/Icons/enemies/Bridge_Troll.png"
			);
		...
		public static Enemy CreateNightDialer()
		{
			var dialer = new Enemy(
				...
				EnemyType.Spectral, 
				DamageType.Curse,
				"res://Assets/Icons/enemies/nightdialer.png"
			);
		...
		public static Enemy CreateHornedServerman()
		{
			var serverman = new Enemy(
				...
				EnemyType.Folklore, 
				DamageType.Physical,
				"res://Assets/Icons/enemies/Horned_Serverman.png"
			);
		...
		public static Enemy CreateBlackBadgeEnforcer()
		{
			var enforcer = new Enemy(
				...
				EnemyType.Normal, 
				DamageType.Curse,
				"res://Assets/Icons/enemies/Blackbadge_Enforcer.png"
			);
		...
		public static Enemy CreateThunderHollowWyrm()
		{
			var wyrm = new Enemy(
				...
				EnemyType.Folklore, 
				DamageType.Electric,
				"res://Assets/Icons/enemies/Thunder_Hollow_Wyrn.png"
			);
		...
		public static Enemy CreateArchivistOfEchoVault()
		{
			var archivist = new Enemy(
				...
				EnemyType.Spectral, 
				DamageType.Psychic,
				"res://Assets/Icons/enemies/Archivist_EchoVault.png"
			);
		...
		public static Enemy CreateDirectorOfBeneathNet()
		{
			var director = new Enemy(
				...
				EnemyType.Spectral, 
				DamageType.Curse,
				"res://Assets/Icons/enemies/Director_BeneathNet.png"
			);
